public class App {
    public static void main(String[] args) throws Exception {
        ...
        SAddress sa1 = new SAddress("Paulin Pinho", 22);
        SAddress sa2 = new SAddress("Jalin Rabey", 456);
        SAddress sa3 = new SAddress("Tomas Aquino Rego", 31);
        Sellers s1 = new Sellers("Maia Carneiro", 34, sa1);
        Sellers s2 = new Sellers("Morgana Brandão", 40, sa2);
        Sellers s3 = new Sellers("Dante Santana Oliveira", 38, sa3);
